...
export default () => (
  <Layout>
    <h1>Privacy Policy for achrafash.me</h1>

    <p>
      At achrafash.me, accessible from achrafash.me, one of our main priorities is the privacy of
      our visitors. This Privacy Policy document contains types of information that is collected and
      recorded by achrafash.me and how we use it.
    </p>
    ...
    <p>
      ...
      website with regards to the information that they shared and/or collect in achrafash.me. This
    ...
    <p>
      By using our website, you hereby consent to our Privacy Policy and agree to its terms. For our
    ...
    <p>
      achrafash.me follows a standard procedure of using log files. These files log visitors when
    ...
    <p>
      Like any other website, achrafash.me uses 'cookies'. These cookies are used to store
    ...
    <p>
      ...
      achrafash.me, which are sent directly to users' browser. They automatically receive your IP
    ...
    <p>
      Note that achrafash.me has no access to or control over these cookies that are used by
    ...
    <p>
      achrafash.me's Privacy Policy does not apply to other advertisers or websites. Thus, we are
    ...
    <p>
      achrafash.me does not knowingly collect any Personal Identifiable Information from children
